    ...
    >
      ...
      <div className="space-y-4">
        ...
        <Slider
          ...
          onValueChange={(vals: number[]) =>
            updateFilter("upperPrice", vals[0])
          }
          className="py-4"
        />
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span
            className={`text-sm font-bold ${filters.metacritic > 70 ? "text-green-500" : "text-yellow-500"}`}
          >
            {filters.metacritic}+
          </span>
        </div>
        <Slider
          ...
          step={5}
          onValueChange={(vals: number[]) =>
            updateFilter("metacritic", vals[0])
          }
          className="py-4"
        />
      </div>
      ...
      <div className="flex items-center justify-between py-2">
        ...
        <Switch
          ...
          onCheckedChange={(checked: boolean) =>
            updateFilter("onSaleOnly", checked)
          }
        />
      </div>
    </aside>
