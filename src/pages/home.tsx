    ...
    <HashRouter>
      <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
              ...
              <div className="lg:hidden">
                <Sheet>
                  ...
                  <SheetContent side="left" className="p-0 w-72">
                    <Sidebar 
                      filters={filters} // Passamos o original para a UI ser rápida
            ...
            <div className='flex items-center justify-content gap-4'>
                ...
                <div className="flex-1 max-w-md relative">
                  ...
                  <Input
                    ...
                    value={searchTerm} // Valor original (instantâneo)
        ...
        <div className="flex flex-1">
          ...
          {/* --- SIDEBAR DESKTOP (Espaço Reservado) --- */}
          {/* Removemos bg-card e border aqui, pois a sidebar fixa já tem isso */}
          ...
          <main className="flex-1 overflow-y-auto p-4 lg:p-8 relative">
            ...
            <div className="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold tracking-tight mb-2">Latest Deals</h1>
                <p className="text-muted-foreground">
                  {/* Mostra '...' enquanto espera o debounce/loading */}
                  {isLoading ? 'Searching...' : `Found ${deals.length} deals for you`}
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 py-6 border-t text-center text-muted-foreground text-xs">
              <p>Powered by <a target='_blank' rel="noreferrer" href='https://github.com/guikino' className="hover:underline text-primary">Guikino</a></p>
            </div>
          </main>
        </div>
      </div>
